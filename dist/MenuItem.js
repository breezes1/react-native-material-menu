...
function MenuItem({ children, itemRender, disabled = false, disabledTextColor = '#bdbdbd', onPress, pressColor = '#e0e0e0', style, textStyle, ...props }) {
    return (react_1.default.createElement(react_native_1.Pressable, { disabled: disabled, style: ({ pressed }) => ({
        ...
        react_1.default.createElement(react_native_1.View, { style: [styles.container, style] }, itemRender ? (react_1.default.isValidElement(itemRender) ? itemRender : itemRender(disabled, disabledTextColor)) : (react_1.default.createElement(react_native_1.Text, { numberOfLines: 1, style: [styles.title, disabled && { color: disabledTextColor }, textStyle] }, children)))));
}
