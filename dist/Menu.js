...
class Menu extends react_1.default.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(react_native_1.View, { ref: this.setContainerRef, collapsable: false, testID: testID },
            anchor,
            react_1.default.createElement(react_native_1.Modal, { visible: modalVisible, onRequestClose: this.onRequestClose, onDismiss: this.onDismiss, onShow: this.onShow, supportedOrientations: [
                    'portrait',
